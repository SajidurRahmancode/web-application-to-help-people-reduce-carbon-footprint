                ...
                <ul>
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            <li>
                                <a href="admin.html" class="side-menu side-menu--active">
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-base text-slate-500 mt-1">Carbon footprint amount</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            ...
                            <div class="col-span-12 xl:col-span-4 mt-6">
                                ...
                                <div class="mt-5">
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                                <img alt="Carbon" src="dist/images/profile-14.jpg">
                                            </div>
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                                <img alt="Carbon" src="dist/images/profile-11.jpg">
                                            </div>
                                            <div class="ml-4 mr-auto">
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                                <img alt="Carbon" src="dist/images/profile-13.jpg">
                                            </div>
                                            <div class="ml-4 mr-auto">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-12.jpg" title="Uploaded at 3 June 2020">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-6.jpg" title="Uploaded at 6 August 2020">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-13.jpg" title="Uploaded at 3 July 2022">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-15.jpg" title="Uploaded at 18 October 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 15 June 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 12 June 2020">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 5 September 2020">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-14.jpg" title="Uploaded at 23 August 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-9.jpg" title="Uploaded at 27 July 2020">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-12.jpg" title="Uploaded at 21 May 2020">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-6.jpg" title="Uploaded at 4 February 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Carbon" class="tooltip rounded-full" src="dist/images/preview-14.jpg" title="Uploaded at 24 July 2020">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                ...
                                <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                                    ...
                                    <div class="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                        <div class="intro-x relative flex items-center mb-3">
                                            <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                    <img alt="Carbon" src="dist/images/profile-12.jpg">
                                                </div>
                                            </div>
                                        ...
                                        <div class="intro-x relative flex items-center mb-3">
                                            <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                    <img alt="Carbon" src="dist/images/profile-6.jpg">
                                                </div>
                                            </div>
                                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                                <div class="flex items-center">
                                                ...
                                                <div class="text-slate-500">
                                                    ...
                                                    <div class="flex mt-2">
                                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Samsung Galaxy S20 Ultra">
                                                            <img alt="Carbon" class="rounded-md border border-white" src="dist/images/preview-6.jpg">
                                                        </div>
                                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Oppo Find X2 Pro">
                                                            <img alt="Carbon" class="rounded-md border border-white" src="dist/images/preview-13.jpg">
                                                        </div>
                                        ...
                                        <div class="intro-x relative flex items-center mb-3">
                                            <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                    <img alt="Carbon" src="dist/images/profile-9.jpg">
                                                </div>
                                            </div>
                                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                                <div class="flex items-center">
